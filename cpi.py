...
load_dotenv() 
db_url =  create_engine(f'{os.getenv("ENGINE")}://{os.getenv("user")}:{os.getenv("PASSWORD")}@{os.getenv("HOST")}/{os.getenv("dbname")}')
...
if __name__=="__main__":
    app.run_server(debug=True,port=3000,host="localhost")
